...
public class ValidateSubsequence {
    ...
    public boolean findTheBruteForceSolution1() {
        return com.rajkumar.algorithms.ValidateSubsequence.bruteForceSolution1(tripledSubSequence, subSequence);
    }
    
    @Benchmark
    public boolean findTheBruteForceSolution2() {
        return com.rajkumar.algorithms.ValidateSubsequence.bruteForceSolution2(tripledSubSequence, subSequence);
    }
    
    @Benchmark
    public boolean findTheBruteForceSolution3() {
        return com.rajkumar.algorithms.ValidateSubsequence.bruteForceSolution3(tripledSubSequence, subSequence);
    }
    
    @Benchmark
    public boolean findTheBruteForceSolution4() {
        return com.rajkumar.algorithms.ValidateSubsequence.bruteForceSolution4(tripledSubSequence, subSequence);
    }
